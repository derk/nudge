(function () {
  ...
  /**
   * @class ColourCtrl
   * @classdesc Colour Controller for setting the band colour
   * @ngInject
   */
  function ColourCtrl ($scope, Colours, $ionicPopup) {
    $scope.debug = true;
    $scope.logs = [];
  ...
  ColourCtrl.$inject = ['$scope', 'Colours', '$ionicPopup'];

  angular
    .module('nudge')
    .controller('ColourCtrl', ColourCtrl);
